...
namespace Ursu_Alexandra_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Ursu_Alexandra_Lab8Context context, Book book)
        ...
        public void UpdateBookCategories(Ursu_Alexandra_Lab8Context context, string[] selectedCategories, Book bookToUpdate)
        {
